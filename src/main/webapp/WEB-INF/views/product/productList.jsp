...
<div class="button-container">
    ...
    <button><a href="products/listProductDelete">Danh sách sản phẩm đã xóa</a></button>
    ...
    <c:forEach var="product" items="${products}">
        <tr>
            ...
            <td>
                ...
                <button style="background-color: red"><a href="/products/delete/${product.id}" onclick="return confirm('Bạn có chắc chắn muốn xoa sản phẩm này chứ ?')">Xóa</a></button>
